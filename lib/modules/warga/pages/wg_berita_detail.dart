...
class WargaBeritaDetailPage extends StatefulWidget {
  final String newsId; 

  const WargaBeritaDetailPage({super.key, required this.newsId});

  @override
  State<WargaBeritaDetailPage> createState() => _WargaBeritaDetailPageState();
}

class _WargaBeritaDetailPageState extends State<WargaBeritaDetailPage> {
  News? news;
            ...
            child: Padding(
              ...
              child: CircleAvatar(
                ...
                child: IconButton(
                  ...
                  onPressed: () => context.go('/wg/berita'), 
                ),
              ),
            ),
          ),
